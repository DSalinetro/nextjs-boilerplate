...
export default function CreativeStorytelling() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-10">
      ...
      <h1 className="mt-4 text-3xl font-bold">Creative Storytelling & Visual Narratives</h1>
      <p className="text-gray-600 mt-1">Conceptual visual storytelling exploring empathy through imagery and narrative.</p>

      <div className="mt-6 rounded-xl border bg-white p-3">
        <img src="/images/typewriter-roses.png" alt="Typewriter with roses" className="w-full rounded-lg"/>
      </div>
