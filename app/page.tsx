...
// use RELATIVE imports so Vercel doesn't complain about "@/..."
...
export default function DesignPage() {
  ...
  const portfolioItems = [
    ...
    },
    {
      ...
      // you asked this one to go to your Medium profile
    ...
    },
    {
      ...
      category: 'Brand Design',
      // make this an internal page (no more external)
    ...
    },
    {
      ...
      // you said this should show moody-library.png in the card
  ...
  const blogPosts = [
    {
      ...
      // you asked this image to be empathy-rose.png
