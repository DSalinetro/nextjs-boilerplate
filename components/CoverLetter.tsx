...
export function CoverLetter({
  ...
  // Use UTC so SSR/CSR render the same string
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-background print:p-4">
      {/* Header */}
      ...
      <div className="space-y-6 print:space-y-3">
        {/* Date */}
        <div className="text-right mb-8 print:mb-3">
        ...
        {/* Opening */}
        <Card className="print:shadow-none print:border print:mb-3">
          <CardContent className="p-6 print:p-3">
            <p className="leading-relaxed print:leading-snug">
              I am writing to express my strong interest in the {positionTitle} position at {companyName}. As a creative
              professional who blends design, research, and storytelling to create human-centered solutions, I am excited
              about the opportunity to contribute to your team's mission of creating meaningful user experiences that drive
        ...
        <Card className="print:shadow-none print:border print:mb-3">
          <CardContent className="p-6 print:p-3">
            <p className="leading-relaxed print:leading-snug mb-4 print:mb-2">
              ...
              launch, designing complete brand ecosystems including packaging, photography, and e-commerce platforms. This
              hands-on experience has taught me the importance of user-centered design in driving conversions and building
              brand loyalty.
            </p>
            <p className="leading-relaxed print:leading-snug">
              My analytical background from roles at Moody's Analytics and as an Appraiser has strengthened my ability to
              translate complex data into compelling visual narratives. I've collaborated with C-suite stakeholders,
        ...
        <Card className="print:shadow-none print:border print:mb-3">
          <CardContent className="p-6 print:p-3">
            <p className="leading-relaxed print:leading-snug mb-4 print:mb-2">
              I am particularly drawn to {companyName} because of your commitment to innovative design solutions and user
              experience excellence. I am excited about the possibility of bringing my unique blend of creative vision,
              research acumen, and empathy-driven approach to your team.
            </p>
            <p className="leading-relaxed print:leading-snug">
              I would welcome the opportunity to discuss how my experience in building brands, conducting user research,
              and creating compelling visual narratives can contribute to {companyName}'s continued success. Thank you for
